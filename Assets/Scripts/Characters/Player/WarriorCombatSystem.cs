...
public class WarriorCombatSystem : PlayerCombat
{
    ...
    void Charge()
    {
        if (PlayerUtilities.CheckSpell(Target.instance.getCurrEnemy(), playerData, ChargeRange, ChargeOnCooldown))
        {
    ...
    void MortalStrike()
    {
        if (PlayerUtilities.CheckSpell(Target.instance.getCurrEnemy(), playerData, Target.instance.MeleeAttackRange, MortalStrikeOnCooldown, MortalStrikeAbilityCost))
        {
            MortalStrikeStart();
        }
    }
    ...
    void Bladestorm()
    {
        if (PlayerUtilities.CheckSpell(playerData, BladestormOnCooldown, BladestormAbilityCost))
        {
    ...
    void AOE_Bladestorm_Damage()
    {
        ...
        {
            result.collider.GetComponent<Enemy>().TakeDamage(playerData.AttackPower * BladestormDamageMultiplier);
        }
